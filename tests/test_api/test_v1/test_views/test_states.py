...
class Test_States(unittest.TestCase):
    ...
    def test_delete_invalid_ID(self):
        '''
            Test state delete with invalid ID
        '''
    ...
    def test_states_create(self):
        ...
        response = self.test_app.post(
            '/api/v1/states/', data=data, content_type='application/json')
        check = json.loads(response.data.decode(defenc()))
    ...
    def test_states_create_invalid_json(self):
        '''
            Test state create function passing bad JSON data
        '''
        data = '{}'
        response = self.test_app.post(
            '/api/v1/states/', data=data, content_type='application/json')
    ...
    def test_states_create_no_name(self):
        '''
            Test state create function without name key
        '''
        data = '{"nop": "nop"}'
        response = self.test_app.post(
            '/api/v1/states/', data=data, content_type='application/json')
    ...
    def test_states_update(self):
        ...
        response = self.test_app.put(
            'api/v1/states/{}'.format(state1.id),
    ...
    def test_states_update_invalid_ID(self):
        '''
            Test state update with invalid id
        '''
    ...
    def test_states_update_invalid_json(self):
        '''
            Test state update with bad JSON data
        '''
        state1 = classes['State'](name="California")
        state1.save()
        data = '{}'
    ...
    def test_states_update_ignore_keys(self):
        '''
        ...
        self.assertNotEqual(state1.updated_at, "nop")
        self.assertNotEqual(state1.created_at, "nop")
        state1.delete()
